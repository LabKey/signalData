...
//                   model: 'LABKEY.SignalData.StandardSource',
                    schemaName: 'lists',
                    queryName: 'SignalDataStandardSource'
                });
            }
                ...
                LABKEY.Query.saveRows({
                    ...
                    success: function(data) {
                        ...
                        LABKEY.Query.saveRows({
                            ...
                            failure: function() {
                                alert('Failed to Save SignalDataStandardSource');
                            },
                            scope: this
                        });
                    },
                    failure: function() {
                        alert('Failed to Save SignalDataStandard: ' + standardRow['Name']);
                    },
                    scope: this
                });
            ...
            success: function(d) {
                if (d.rows.length == 1) {
                        ...
                        success: function(sd) {
                            if (sd.rows.length > 0) {
                                LABKEY.Query.deleteRows({
                                    ...
                                    rows: sd.rows,
                                    success: function() { },
                                    failure: function() { alert('Failed to cleanup Lists.SignalDataStandardSource'); }
                                });
                            }
                        },
                        scope: this
                    ...
                    LABKEY.Query.deleteRows({
                        ...
                        failure: function() { alert('Failed to cleanup Lists.SignalDataStandard'); },
                        scope: this
                    });
